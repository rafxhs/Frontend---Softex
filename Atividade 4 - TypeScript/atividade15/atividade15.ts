...
const numero: number= Number (prompt("Digite algum valor entre 1 e 7: "));
const diasDasemana: string  []= ['1 - Domingo', ' 2 - Segunda-feira', '3 - Terça-feira', ' 4 - Quarta-feira', ' 5 - Quinta-feira', '6  - Sexta-feira', '7 - Sábado'];

let diaEmExibicao = diasDasemana.find((_, index) => index == (numero - 1));
alert(diaEmExibicao);
