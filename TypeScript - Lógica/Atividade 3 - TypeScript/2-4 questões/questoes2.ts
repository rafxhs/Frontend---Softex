...
let condicao= numeros?.split(" ");
let numerosSemEspacos= condicao?.join("");
...
let nomeDoAnimal= prompt("Digite o nome de um animal: ");
...
let primeiroNome1= prompt("Digite o seu primeiro nome:");
let sobrenome1= prompt("Digite o seu sobrenome:");
...
const letra= prompt("Digite qualquer coisa:");

alert("A quantidade de caracteres presente no que foi digitado é= " + letra?.length);
