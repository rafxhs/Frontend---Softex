...
function calcularImpostoRenda(salario) {
    ...
    if ((salario >= 1903.99) && (salario <= 2826.65)) {
        var impostoDeRenda1 = salario * 0.075;
        alert("Voc\u00EA pagar\u00E1 ".concat(impostoDeRenda1, " de imposto de renda"));
    }
    if ((salario >= 2826.66) && (salario <= 3751.05)) {
        var impostoDeRenda2 = salario * 0.15;
        alert("Voc\u00EA pagar\u00E1 ".concat(impostoDeRenda2, " de imposto de renda"));
    }
    if ((salario >= 3751.06) && (salario <= 4664.68)) {
        var impostoDeRenda3 = salario * 0.225;
        alert("Voc\u00EA pagar\u00E1 ".concat(impostoDeRenda3, " de imposto de renda"));
    }
    if (salario >= 4664.68) {
        var impostoDeRenda4 = salario * 0.275;
        alert("Voc\u00EA pagar\u00E1 ".concat(impostoDeRenda4, " de imposto de renda"));
    }
    else if (salario == 0) {
        alert("Digite um valor de salário válido!!");
    }
}
var salario = Number(prompt("Digite o seu salário e saiba quanto de imposto de renda você deve pagar:"));
